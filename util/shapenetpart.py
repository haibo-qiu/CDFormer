...
import numpy as np
import torch
# import torch_points_kernels.furthest_point_sample as fps
...
class ShapeNetPartNormal(Dataset):
    ...
    sample_num = [2349, 62, 44, 740, 3053, 55, 628, 312, 1261, 367, 151, 146, 234, 54, 121, 4421]
    part_num = [2349, 2349, 2349, 2349,   62,   62,   44,   44,  740,  740,  740,
                740, 3053, 3053, 3053, 3053,   55,   55,   55,  628,  628,  628,
                312,  312, 1261, 1261, 1261, 1261,  367,  367,  151,  151,  151,
                151,  151,  151,  146,  146,  234,  234,  234,   54,   54,   54,
                121,  121,  121, 4421, 4421, 4421]
