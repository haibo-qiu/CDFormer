from torch.optim.lr_scheduler import LambdaLR, StepLR, OneCycleLR, _LRScheduler
import torch.optim as optim
import math

class CosineAnnealingWarmupRestarts(_LRScheduler):
    """ Borrowed from https://github.com/katsura-jp/pytorch-cosine-annealing-with-warmup
